...
public class DetailsController extends TimerTask{
    ...
    public void initialize(){
        ...
        Conversions.toCelsius(list.get(1).mainParameters.temperature);
        temp2.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(2).mainParameters.temperature);
        temp3.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(3).mainParameters.temperature);
        temp4.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(4).mainParameters.temperature);
        temp5.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(5).mainParameters.temperature);
        temp6.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(6).mainParameters.temperature);
        temp7.setText(String.valueOf(bd) + "°");
        Conversions.toCelsius(list.get(7).mainParameters.temperature);
